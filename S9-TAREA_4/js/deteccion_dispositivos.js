...
export default function userDeviceInfo(id) {
  ...
  if (isDesktop.mac()) {
    $id.innerHTML += `<p><mark>Descargar nuestro software para  Mac OS</mark></p>`;
  }
  ...
  /*redirecciones*/
  /*if(isMobile.android()){
        window.location.href ="https://www.youtube.com/watch?v=WHfyN411fd4&list=PLvq-jIkSeTUZ6QgYYO3MwG9EMqC-KoLXA&index=93&ab_channel=jonmircha"
    }*/
}